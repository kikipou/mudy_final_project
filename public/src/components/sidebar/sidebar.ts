        ...
        if (this.shadowRoot) {
            this.shadowRoot.innerHTML = `
                ...
                <div class="body">
                    <div class="items">
                        <button class="item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zm0 2c-3.315 0-10 1.672-10 5v2h20v-2c0-3.328-6.685-5-10-5z" fill="#FFFFFF"/><"</svg>  
                        </button>
                        <button class="item">
